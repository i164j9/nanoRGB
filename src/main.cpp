...
// fire2012WithPallet not used by default if you
// want it add it to the SimplePatternList below
...
void pacifica();
void demoReel();
// firePallet not used by default if you want
...
void vu(){
  ...
  gHue = beatsin16( 13, 0, NUM_LEDS-1 );
  fadeToBlackBy( leds, NUM_LEDS, 10);
    
  int pos = map(analogRead(15),1,4095,0,NUM_LEDS);
  pos = map(pos,100,150,0,NUM_LEDS);
